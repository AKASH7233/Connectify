    ...
    <div className='h-[100vh] relative'>
       ...
       {showEditingOptions &&
          <div className='absolute bottom-0 '>
           <button onClick={deleteProfileImg} className='w-[50vw] py-3 bg-gray-900 text-red-500'>delete</button>
           <label className='w-[50vw] pl-[20vw] py-3' htmlFor='pic'>upload</label>
           <input 
           type="file"
           className='hidden' 
           id='pic'
           ...
           />
           <button onClick= {upload} className='py-4 w-[100vw] border border-gray-800 hover:bg-gray-800 opacity-90'><h2 className='text-center'>Set as Profile Image</h2></button>
         </div>
       }
    </div>
  )
