...
//             <Loader color="#00BFFF" height={300} width={300} />
//         ) : (
//             <div className={`h-screen max-h-screen flex flex-col ${isMobile ? '' : 'md:flex-row'} bg-gradient-to-r from-gray-600 to-black`}>
//                 {/* Sidebar */}
...
//                 {/* Main Chat Area */}
//                 {person ? (
//                     <div className={`w-full ${isMobile ? '' : 'md:w-4/5'} bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 h-screen flex flex-col justify-between relative mt-4 md:mt-0 shadow-lg`}>
//                         {/* Header */}
//                         <header onClick={() => { window.location.href = `user/${person?._id}` }} className="cursor-pointer md:w-[15rem] absolute top-0 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 text-white py-4 px-6 items-center shadow-md flex justify-between rounded-full my-5">
//                             <div className="flex items-center justify-start">
//                                 {person?.ProfileImage ? 
...
//                 {isMobile && (
//                     <button className="fixed top-4 left-4 bg-gray-700 text-white p-3 rounded-full shadow-lg z-50" onClick={() => setIsSidebarOpen(!isSidebarOpen)}>
